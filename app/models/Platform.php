...
/**
 * Platform Model
 * Handles database operations for platforms.
 */
class Platform extends Model
{
    ...
    * @return array|null Platform data if found, null otherwise.
    */
    public function findById(int $id): ?array
    {
        try {
            ...
            error_log("Error fetching platform by ID: " . $e->getMessage());
            return null;
        }
    }

    /**
    * Fetches a single platform by its slug.
    ...
    */
    public function findBySlug(string $slug): ?array
    {
        try {
            ...
            error_log("Error fetching platform by slug: " . $e->getMessage());
            return null;
        }
    }

    /**
    * Fetches all active platforms, optionally limited.
    * @param int|null $limit Maximum number of platforms to return.
    * @return array List of platform data.
    */
    public function getAll(?int $limit = null): array
    {
        try {
            ...
            error_log("Error fetching all platforms: " . $e->getMessage());
            return [];
        }
    }
    ...
    * @param array $data Associative array of platform data (e.g., 'name', 'slug', 'icon').
    ...
    */
    public function create(array $data): int|false
    {
        ...
        $query = "INSERT INTO {$this->table} (name, slug, icon, is_active) 
                  VALUES (:name, :slug, :icon, :is_active)";
    ...
    * @param array $data Associative array of platform data.
    ...
    */
    public function update($id, array $data): bool
    {
        ...
        foreach($data as $key => $value) {
            if (in_array($key, ['name', 'slug', 'icon', 'is_active'])) {
                $setClauses[] = "$key = :$key";
                $params[":$key"] = $value;
            }
        }
